...
// ** have to reload page after for toggles to reset to new values (if applicable)
/****************************************************/  
...
ArrayAlarm.controller('WakeController', ['$scope', function($scope){
...
// saving the alarm
/*******************************************************************/ 
$scope.hourSaved = (localStorage.getItem('Settings'));
      $scope.toggleHour = function(hourSetting){
        console.log(hourSetting);
        localStorage.setItem("Settings", JSON.stringify(hourSetting));
        console.log('Status saved');
        changeData();
    };
...
.........................
the undefined on first toggle fucks stuff up
